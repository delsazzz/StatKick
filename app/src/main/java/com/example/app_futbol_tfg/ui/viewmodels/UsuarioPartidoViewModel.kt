...
class UsuarioPartidoViewModel(private val repository: UsuarioPartidoRepository) : ViewModel() {
    ...
    suspend fun countByUsuario(idUsuario: Int): Int = repository.countByUsuario(idUsuario)
    suspend fun getRelacion(idUsuario: Int, idPartido: Int): UsuarioPartidoEntity? = repository.getRelacion(idUsuario, idPartido)
