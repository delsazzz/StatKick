...
class TemporadaViewModel(private val repository: TemporadaRepository) : ViewModel() {
    ...
    suspend fun getTemporadaById(id: Int): TemporadaEntity? = repository.getById(id)
    suspend fun getByTemporada(temporada: String): TemporadaEntity? = repository.getByTemporada(temporada)
