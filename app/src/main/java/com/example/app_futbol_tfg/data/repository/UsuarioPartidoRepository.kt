...
class UsuarioPartidoRepository(
    ...
    // Usa la query que cruza Usuario_Partido con Partidos para obtener
    // solo los partidos del usuario, no todos los del estadio
    fun countPartidosEnEstadio(idUsuario: Int, idEstadio: Int): Flow<Int> =
        usuarioPartidoDao.countPartidosEnEstadio(idUsuario, idEstadio)
}