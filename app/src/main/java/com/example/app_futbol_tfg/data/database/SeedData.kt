...
object SeedData {
    ...
    private class SeedIds {
        ...
        // Estadios originales
        var idBernabeu = 0; var idCampNou = 0; var idOldTrafford = 0; var idAllianz = 0
        var idParcDesPrinces = 0; var idAllianzArena = 0; var idSignalIduna = 0; var idDaLuz = 0
        var idSanchezPizjuan = 0; var idMestalla = 0; var idAnfield = 0; var idEmirates = 0
        var idDoDragao = 0; var idMonumental = 0; var idJohanCruyffArena = 0
        // Estadios La Liga 2023-24
        var idMetropolitano = 0; var idSanMames = 0; var idRealeArena = 0; var idBenitoVillamarin = 0
        var idGranCanaria = 0; var idColiseum = 0; var idElSadar = 0; var idMendizorroza = 0
        var idLaCeramica = 0; var idVallecas = 0; var idNuevoMirandilla = 0; var idVisitMallorca = 0
        var idLosCarmenes = 0; var idPowerHorse = 0; var idBalaidos = 0; var idMontilivi = 0
        // Estadios Champions 2023-24
        var idEtihad = 0; var idSanSiro = 0; var idMaradona = 0; var idOlimpicoRoma = 0
        var idJoseAlvalade = 0; var idEstadioMunicipalBraga = 0; var idDeKuip = 0; var idPhilipsStadion = 0
        var idJanBreydel = 0; var idLottoPark = 0; var idCelticPark = 0; var idRamsPark = 0
        var idSukruSaracoglu = 0; var idRedBullArenaSalzburg = 0; var idGeneraliArena = 0; var idParkenStadion = 0
    ...
    private suspend fun seedEstadios(database: AppDatabase, ids: SeedIds) {
        ...
        ids.idBernabeu        = dao.insert(EstadioEntity(nombre = "Santiago Bernabéu",      idLocalidad = ids.idMadrid,      idPais = ids.idEspana,      capacidad = 81044,  latitud = 40.4531,   longitud = -3.6883,  direccion = "Av. de Concha Espina, 1, Madrid")).toInt()
        ids.idCampNou         = dao.insert(EstadioEntity(nombre = "Spotify Camp Nou",       idLocalidad = ids.idBarcelona,   idPais = ids.idEspana,      capacidad = 99354,  latitud = 41.3809,   longitud = 2.1228,   direccion = "C. d'Arístides Maillol, Barcelona")).toInt()
        ...
        ids.idAllianz         = dao.insert(EstadioEntity(nombre = "Allianz Stadium",        idLocalidad = ids.idTurin,       idPais = ids.idItalia,      capacidad = 41507,  latitud = 45.1096,   longitud = 7.6412,   direccion = "Corso Gaetano Scirea, 50, Turín")).toInt()
        ids.idParcDesPrinces  = dao.insert(EstadioEntity(nombre = "Parc des Princes",       idLocalidad = ids.idParis,       idPais = ids.idFrancia,     capacidad = 47929,  latitud = 48.8414,   longitud = 2.2530,   direccion = "24 Rue du Commandant Guilbaud, París")).toInt()
        ...
        ids.idSanchezPizjuan  = dao.insert(EstadioEntity(nombre = "Ramón Sánchez-Pizjuán", idLocalidad = ids.idSeVilla,     idPais = ids.idEspana,      capacidad = 43883,  latitud = 37.3840,   longitud = -5.9705,  direccion = "C. Sevilla Fútbol Club, Sevilla")).toInt()
        ids.idMestalla        = dao.insert(EstadioEntity(nombre = "Estadio de Mestalla",    idLocalidad = ids.idValencia,    idPais = ids.idEspana,      capacidad = 49430,  latitud = 39.4747,   longitud = -0.3583,  direccion = "C. de Mestalla, 2, Valencia")).toInt()
        ids.idAnfield         = dao.insert(EstadioEntity(nombre = "Anfield",                idLocalidad = ids.idLiverpool,   idPais = ids.idInglaterra,  capacidad = 61276,  latitud = 53.4308,   longitud = -2.9608,  direccion = "Anfield Rd, Liverpool")).toInt()
        ids.idEmirates        = dao.insert(EstadioEntity(nombre = "Emirates Stadium",       idLocalidad = ids.idLondres,     idPais = ids.idInglaterra,  capacidad = 60704,  latitud = 51.5549,   longitud = -0.1084,  direccion = "Hornsey Rd, Londres")).toInt()
        ...
        ids.idMetropolitano   = dao.insert(EstadioEntity(nombre = "Civitas Metropolitano",       idLocalidad = ids.idMadrid,         idPais = ids.idEspana,      capacidad = 68456,  latitud = 40.4361,   longitud = -3.5994,  direccion = "Av. de Luis Aragonés, s/n, Madrid")).toInt()
        ids.idSanMames        = dao.insert(EstadioEntity(nombre = "San Mamés",                   idLocalidad = ids.idBilbao,         idPais = ids.idEspana,      capacidad = 53289,  latitud = 43.2641,   longitud = -2.9494,  direccion = "Rafael Moreno Pitxitxi, s/n, Bilbao")).toInt()
        ids.idRealeArena      = dao.insert(EstadioEntity(nombre = "Reale Arena",                 idLocalidad = ids.idSanSebastian,   idPais = ids.idEspana,      capacidad = 39500,  latitud = 43.3016,   longitud = -1.9733,  direccion = "Paseo de Anoeta, 1, San Sebastián")).toInt()
        ids.idBenitoVillamarin= dao.insert(EstadioEntity(nombre = "Estadio Benito Villamarín",   idLocalidad = ids.idSeVilla,        idPais = ids.idEspana,      capacidad = 60720,  latitud = 37.3561,   longitud = -5.9811,  direccion = "Av. de Heliópolis, s/n, Sevilla")).toInt()
        ...
        ids.idElSadar         = dao.insert(EstadioEntity(nombre = "El Sadar",                    idLocalidad = ids.idPamplona,       idPais = ids.idEspana,      capacidad = 23576,  latitud = 42.7966,   longitud = -1.6368,  direccion = "C. Serapio Huici, s/n, Pamplona")).toInt()
        ids.idMendizorroza    = dao.insert(EstadioEntity(nombre = "Estadio de Mendizorroza",     idLocalidad = ids.idVitoriaGasteiz, idPais = ids.idEspana,      capacidad = 19840,  latitud = 42.8370,   longitud = -2.6883,  direccion = "C. Portal de Lasarte, 1, Vitoria-Gasteiz")).toInt()
        ids.idLaCeramica      = dao.insert(EstadioEntity(nombre = "Estadio de la Cerámica",      idLocalidad = ids.idVillarreal,     idPais = ids.idEspana,      capacidad = 23500,  latitud = 39.9444,   longitud = -0.1036,  direccion = "Carrer de la Ceràmica, s/n, Villarreal")).toInt()
        ...
        ids.idEtihad          = dao.insert(EstadioEntity(nombre = "Etihad Stadium",              idLocalidad = ids.idManchester2,    idPais = ids.idInglaterra,  capacidad = 53400,  latitud = 53.4831,   longitud = -2.2004,  direccion = "Ashton New Rd, Manchester")).toInt()
        ids.idSanSiro         = dao.insert(EstadioEntity(nombre = "Stadio Giuseppe Meazza",      idLocalidad = ids.idMilan,          idPais = ids.idItalia,      capacidad = 75923,  latitud = 45.4781,   longitud = 9.1240,   direccion = "Piazzale Angelo Moratti, Milán")).toInt()
        ...
        ids.idJoseAlvalade    = dao.insert(EstadioEntity(nombre = "Estádio José Alvalade",       idLocalidad = ids.idLisboa,         idPais = ids.idPortugal,    capacidad = 50095,  latitud = 38.7613,   longitud = -9.1606,  direccion = "Rua Professor Fernando da Fonseca, Lisboa")).toInt()
        ...
        ids.idPhilipsStadion  = dao.insert(EstadioEntity(nombre = "Philips Stadion",             idLocalidad = ids.idEindhoven,      idPais = ids.idPaisesBajos, capacidad = 35000,  latitud = 51.4416,   longitud = 5.4674,   direccion = "Frederiklaan 10A, Eindhoven")).toInt()
        ids.idJanBreydel      = dao.insert(EstadioEntity(nombre = "Jan Breydel Stadion",         idLocalidad = ids.idBrujas,         idPais = ids.idBelgica,     capacidad = 29062,  latitud = 51.1934,   longitud = 3.1806,   direccion = "Olympialaan 74, Brujas")).toInt()
        ...
        ids.idCelticPark      = dao.insert(EstadioEntity(nombre = "Celtic Park",                 idLocalidad = ids.idGlasgow,        idPais = ids.idEscocia,     capacidad = 60411,  latitud = 55.8499,   longitud = -4.2055,  direccion = "Celtic Park, Glasgow")).toInt()
        ids.idRamsPark        = dao.insert(EstadioEntity(nombre = "RAMS Park",                   idLocalidad = ids.idEstambul,       idPais = ids.idTurquia,     capacidad = 52600,  latitud = 41.1034,   longitud = 28.9910,  direccion = "Huzur Mah., Sariyer, Estambul")).toInt()
        ...
        ids.idRedBullArenaSalzburg = dao.insert(EstadioEntity(nombre = "Red Bull Arena Salzburg", idLocalidad = ids.idSalzburg,     idPais = ids.idAustria,     capacidad = 29520,  latitud = 47.8164,   longitud = 12.9983,  direccion = "Lieferinger Hauptstraße 1, Salzburgo")).toInt()
    ...
    private suspend fun seedEquipos(database: AppDatabase, ids: SeedIds) {
        ...
        ids.idFCBarcelona   = dao.insert(EquipoEntity(nombre = "FC Barcelona",       anioFundacion = 1899, idEstadio = ids.idCampNou,          idLocalidad = ids.idBarcelona,   idPais = ids.idEspana,      escudo = "escudo_barcelona")).toInt()
    ...
    private suspend fun seedPartidos(database: AppDatabase, ids: SeedIds) {
        ...
        ids.idPartido1  = dao.insert(PartidoEntity(idEquipoLocal = ids.idRealMadrid,       idEquipoVisitante = ids.idFCBarcelona,  golesLocal = 2, golesVisitante = 1, fecha = "2024-04-21", idTemporada = ids.idTemp2324, idCompeticion = ids.idLaLiga,       idEstadio = ids.idBernabeu,         jornada = "Jornada 32")).toInt()
        ...
        ids.idPartido3  = dao.insert(PartidoEntity(idEquipoLocal = ids.idPSG,              idEquipoVisitante = ids.idFCBarcelona,  golesLocal = 2, golesVisitante = 3, fecha = "2024-04-10", idTemporada = ids.idTemp2324, idCompeticion = ids.idChampions,    idEstadio = ids.idParcDesPrinces,   jornada = "Cuartos")).toInt()
        ...
        ids.idPartido6  = dao.insert(PartidoEntity(idEquipoLocal = ids.idFCBarcelona,  idEquipoVisitante = ids.idValenciaCF,       golesLocal = 2, golesVisitante = 0, fecha = "2023-09-16", idTemporada = ids.idTemp2324, idCompeticion = ids.idLaLiga,       idEstadio = ids.idCampNou,          jornada = "Jornada 5")).toInt()
        ...
        ids.idPartido9  = dao.insert(PartidoEntity(idEquipoLocal = ids.idFCBarcelona,  idEquipoVisitante = ids.idSevillaFC,        golesLocal = 3, golesVisitante = 2, fecha = "2024-01-21", idTemporada = ids.idTemp2324, idCompeticion = ids.idLaLiga,       idEstadio = ids.idCampNou,          jornada = "Jornada 21")).toInt()
        ids.idPartido10 = dao.insert(PartidoEntity(idEquipoLocal = ids.idRealMadrid,       idEquipoVisitante = ids.idFCBarcelona,  golesLocal = 2, golesVisitante = 2, fecha = "2024-03-03", idTemporada = ids.idTemp2324, idCompeticion = ids.idLaLiga,       idEstadio = ids.idBernabeu,         jornada = "Jornada 27")).toInt()
        ...
        ids.idPartido31 = dao.insert(PartidoEntity(idEquipoLocal = ids.idArsenal,          idEquipoVisitante = ids.idBayernMunich,           golesLocal = 1, golesVisitante = 1, fecha = "2024-04-10", idTemporada = ids.idTemp2324, idCompeticion = ids.idChampions,    idEstadio = ids.idEmirates,         jornada = "Cuartos")).toInt()
        ...
        ids.idPartido33 = dao.insert(PartidoEntity(idEquipoLocal = ids.idFCBarcelona,  idEquipoVisitante = ids.idAjax,             golesLocal = 4, golesVisitante = 1, fecha = "2024-09-18", idTemporada = ids.idTemp2425, idCompeticion = ids.idChampions,    idEstadio = ids.idCampNou,          jornada = "Fase Liga")).toInt()
        ...
        ids.idPartido41 = dao.insert(PartidoEntity(idEquipoLocal = ids.idJuventus,         idEquipoVisitante = ids.idBayernMunich,           golesLocal = 1, golesVisitante = 2, fecha = "2024-08-07", idTemporada = ids.idTemp2425, idCompeticion = ids.idCopaAmistosa, idEstadio = ids.idAllianz,          jornada = "Pretemporada")).toInt()
        ...
        ids.idPartido49 = dao.insert(PartidoEntity(idEquipoLocal = ids.idFCBarcelona,  idEquipoVisitante = ids.idBayernMunich,           golesLocal = 1, golesVisitante = 3, fecha = "2025-04-10", idTemporada = ids.idTemp2526, idCompeticion = ids.idChampions,    idEstadio = ids.idCampNou,          jornada = "Cuartos")).toInt()
