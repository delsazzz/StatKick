...
object SeedData {
    ...
    suspend fun seed(database: AppDatabase) {
        ...
        // PAISES
        // =========================
        val idEspana = paisDao.insert(PaisEntity(nombre = "España")).toInt()
        val idInglaterra = paisDao.insert(PaisEntity(nombre = "Inglaterra")).toInt()
        val idItalia = paisDao.insert(PaisEntity(nombre = "Italia")).toInt()
        val idFrancia = paisDao.insert(PaisEntity(nombre = "Francia")).toInt()

        // =========================
        // LOCALIDADES
        // =========================
        val idMadrid = localidadDao.insert(
            LocalidadEntity(nombre = "Madrid", idPais = idEspana)
        ).toInt()

        val idBarcelona = localidadDao.insert(
            LocalidadEntity(nombre = "Barcelona", idPais = idEspana)
        ).toInt()

        val idManchester = localidadDao.insert(
            LocalidadEntity(nombre = "Manchester", idPais = idInglaterra)
        ).toInt()

        val idTurin = localidadDao.insert(
            LocalidadEntity(nombre = "Turín", idPais = idItalia)
        ).toInt()

        val idParis = localidadDao.insert(
            LocalidadEntity(nombre = "París", idPais = idFrancia)
        ).toInt()

        // =========================
        // ESTADIOS
        // =========================
        val idBernabeu = estadioDao.insert(
            EstadioEntity(
        ...
        val idCampNou = estadioDao.insert(
            EstadioEntity(
                nombre = "Camp Nou",
                idLocalidad = idBarcelona,
                idPais = idEspana,
                capacidad = 99354
            )
        ).toInt()

        val idOldTrafford = estadioDao.insert(
            EstadioEntity(
                nombre = "Old Trafford",
        ...
        val idAllianz = estadioDao.insert(
            EstadioEntity(
                nombre = "Allianz Stadium",
                idLocalidad = idTurin,
                idPais = idItalia,
                capacidad = 41507
            )
        ...
        val idParcDesPrinces = estadioDao.insert(
            EstadioEntity(
        ...
        // COMPETICIONES
        // =========================
        val idLaLiga = competicionDao.insert(
            CompeticionEntity(nombre = "LaLiga", idPais = idEspana)
        ).toInt()

        val idPremier = competicionDao.insert(
            CompeticionEntity(nombre = "Premier League", idPais = idInglaterra)
        ).toInt()

        val idChampions = competicionDao.insert(
            CompeticionEntity(nombre = "Champions League", idPais = null)
        ).toInt()

        // =========================
        // TEMPORADAS
        // =========================
        val idTemp2324 = temporadaDao.insert(
            TemporadaEntity(temporada = "2023/2024")
        ).toInt()

        val idTemp2425 = temporadaDao.insert(
            TemporadaEntity(temporada = "2024/2025")
        ).toInt()

        // =========================
        // EQUIPOS
        // =========================
        val idRealMadrid = equipoDao.insert(
            EquipoEntity(
                nombre = "Real Madrid",
                anioFundacion = 1902,
        ...
        val idBarcelonaEquipo = equipoDao.insert(
            EquipoEntity(
                nombre = "FC Barcelona",
                anioFundacion = 1899,
                idEstadio = idCampNou,
        ...
        val idManchesterUnited = equipoDao.insert(
            EquipoEntity(
        ...
        val idJuventus = equipoDao.insert(
            EquipoEntity(
                nombre = "Juventus",
                anioFundacion = 1897,
                idEstadio = idAllianz,
        ...
        val idEspanaSeleccion = equipoDao.insert(
            EquipoEntity(
                nombre = "España",
                anioFundacion = null,
                idEstadio = null,
        ...
        val idFranciaSeleccion = equipoDao.insert(
            EquipoEntity(
                nombre = "Francia",
                anioFundacion = null,
                idEstadio = null,
        ...
        // JUGADORES
        // =========================
        val idBellingham = jugadorDao.insert(
            JugadorEntity(
                nombre = "Jude",
                ...
                idLocalidad = idManchester,
                idPais = idInglaterra,
                idEquipoActual = idRealMadrid,
                posicion = "Centrocampista",
                activo = true
            )
        ).toInt()

        val idVinicius = jugadorDao.insert(
            JugadorEntity(
                nombre = "Vinicius",
                apellido1 = "Junior",
                apellido2 = null,
        ...
        val idLewandowski = jugadorDao.insert(
            JugadorEntity(
                nombre = "Robert",
                apellido1 = "Lewandowski",
                apellido2 = null,
